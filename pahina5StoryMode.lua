...
function scene:createScene( event )
    ...
    local background = display.newImage("storyline/6.jpg")
    ...
    --STORY LINE
    local text = display.newText("siya ay naligaw sa Fantasia at", 100, 100, "Chinacat", 50)
    text.x = display.contentWidth * 0.5
    text.y = display.contentHeight * 0.55
    text:setTextColor(0,0,1)

    local text2 = display.newText("nakalimutan ang daan niya pauwi. ", 100, 100, "Chinacat", 50)
