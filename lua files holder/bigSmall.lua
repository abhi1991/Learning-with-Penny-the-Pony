...
function scene:createScene( event )
    ...
    local function chooseOptionColor(num)
        if num == 1 then
            return "images/animals/animalSizes/beeBig.png"
        elseif num == 2 then
            return "images/animals/animalSizes/bunnyBig.png"
        elseif num == 3 then
            return "images/animals/animalSizes/catBig.png"
        elseif num == 4 then
            return "images/animals/animalSizes/chickenBig.png"
        elseif num == 5 then
            return "images/animals/animalSizes/cowBig.png"
        elseif num == 6 then
            return "images/animals/animalSizes/dogBig.png"
        elseif num == 7 then
            return "images/animals/animalSizes/duckBig.png"
        elseif num == 8 then
            return "images/animals/animalSizes/elephantBig.png"
        elseif num == 9 then
            return "images/animals/animalSizes/horseBig.png"
        elseif num == 10 then
            return "images/animals/animalSizes/pigBig.png"
        elseif num == 11 then
            return "images/animals/animalSizes/sheepBig.png"
        elseif num == 12 then
            return "images/animals/animalSizes/turkeyBig.png"
        end
    end
