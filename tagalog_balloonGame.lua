...
function scene:createScene( event )
	...
	local instr = display.newImage("images/instructions/tagalog_popBalloon.png")
        instr.x = display.contentWidth * 0.5
        instr.y = display.contentHeight * 0.5
    instr:scale(0.7,0.7)
    external.intruct("tagBalloon")
	...
	local function restartGame()
		storyboard.gotoScene("refresh_tagalog_balloonGame", "fade", 300)
