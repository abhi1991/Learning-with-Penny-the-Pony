...
function scene:createScene( event )
    ...
    local function restartGame()
        storyboard.gotoScene("refresh_tagalog_countingNumGame", "fade", 300)
    end
    ...
    restartButton.y = display.contentHeight * 0.5
    ...
    backMenuButton.x = display.contentWidth * 0.79
