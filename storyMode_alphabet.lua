...
function scene:createScene( event )
    ...
    local instruction = display.newImage("images/help/help6.png")
    ...
    local trackText = display.newText("Lives: "..trackNum, 0, 0, "Chinacat", 50)
    ...
    local message = display.newText("Game Over!", 0, 0, "Chinacat", 55)
