...
function scene:createScene( event )
    ...
    -- STORY LINE --
    local image1 = display.newImageRect("storyline/FINAL/eng1.png", display.contentWidth, display.contentHeight)
    image1.x = display.contentWidth * 0.5
    image1.y = display.contentHeight * 0.5
    screen:insert(image1)
    
    local image2 = display.newImageRect("storyline/FINAL/eng2.png", display.contentWidth, display.contentHeight)
    image2.x = display.contentWidth * 0.5
    image2.y = display.contentHeight * 0.5
    image2.alpha = 0
    screen:insert(image2)
    
    local image3 = display.newImageRect("storyline/FINAL/eng3.png", display.contentWidth, display.contentHeight)
    image3.x = display.contentWidth * 0.5
    image3.y = display.contentHeight * 0.5
    image3.alpha = 0
    screen:insert(image3)
    
    local image4 = display.newImageRect("storyline/FINAL/eng4.png", display.contentWidth, display.contentHeight)
    image4.x = display.contentWidth * 0.5
    image4.y = display.contentHeight * 0.5
    image4.alpha = 0
    screen:insert(image4)
    
    local image5 = display.newImageRect("storyline/FINAL/eng5.png", display.contentWidth, display.contentHeight)
    image5.x = display.contentWidth * 0.5
    image5.y = display.contentHeight * 0.5
    image5.alpha = 0
    screen:insert(image5)
    
    local image6 = display.newImageRect("storyline/FINAL/eng6.png", display.contentWidth, display.contentHeight)
    ...
    skipButton = widget.newButton{
        defaultFile = "buttons/skip1.png",
        overFile = "buttons/skip.png",
        onRelease = function()
            storyboard.gotoScene("storyMode_colorMatching", "fade", 400)
        end,
    }
