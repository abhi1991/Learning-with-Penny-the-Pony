...
function scene:createScene( event )
    ...
    local instr = display.newImage("images/help/help2.png")
    ...
    local function goToMenu()
        storyboard.gotoScene( "storyMode_identifyShapes", "fade", 400 )
    end
    ...
    exitButton.x = display.contentWidth * 0.4
    ...
    function right()
        ...
        if times == 5 then
            ...
            transition.to(nextButton, {alpha = 0, time = 200})
            transition.to(instruction, {alpha = 0, time = 200})
