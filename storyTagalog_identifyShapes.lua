...
function scene:createScene( event )
    ...
    local instr = display.newImage("images/instructions/tagalog_identShapes.png")
        instr.x = display.contentWidth * 0.5
        instr.y = display.contentHeight * 0.5
    instr:scale(0.7,0.7)
    external.intruct("tagShape")
    ...
    local title = display.newText("Tukuyin ang hugis", 0, 0, "Chinacat", 40)
    title.x = W * 0.2725
    title.y = H * 0.2
    ...
    local questionNumText = display.newText("Hugis # "..questionNumber, 0, 0, "Chinacat", 30)
    ...
    menuButton = widget.newButton{
        ...
        onRelease = function()
            storyboard.gotoScene("storyTagalog_countingNumGame", "fade", 400)
        end,
    }
    menuButton.alpha = 0
    ...
    nextButton = widget.newButton
    {
        ...
        onRelease = function()
            ...
            questionNumText.text = "Hugis # "..questionNumber
            nextButton.alpha = 0
            message.alpha = 0
            createShape()
        end,
